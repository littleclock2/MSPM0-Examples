...
但是由于未知原因，一般是无法成功安装上该芯片包。需要各位单独下载芯片包然后离线安装。在QQ群中提供了芯片包，名称为`TexasInstruments.MSPM0L11XX_L13XX_DFP.1.2.1.pack`

下载之后双击，会弹出报错界面，但是不用管，点击确定。
