...
//更新到显存
void OLED_Display(u8 *Image1,u8 *Image2)
{
...
//显示字符
void OLED_ShowChar(u16 x,u16 y,char chr,u16 size1,u16 color)
{
...
//*chr:字符串起始地址 
//mode:0,反色显示;1,正常显示
void OLED_ShowString(u16 x,u16 y,char *chr,u16 size1,u16 color)
{
