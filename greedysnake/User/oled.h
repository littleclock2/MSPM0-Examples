...
#define OLED_IIC_Transmit(addr,data,len)			HAL_I2C_Master_Transmit(&hi2c1,addr,data,len,10)
#define OLED_IIC_MemWrite(data,len)					HAL_I2C_Mem_Write(&hi2c1,OLED_IIC_ADDR_W,OLED_IIC_DATA,I2C_MEMADD_SIZE_8BIT,data,len,100)

#define OLED_X_MAX 128
#define OLED_Y_MAX 64

#define OLED_IIC_ADDR_W 0x78
#define OLED_IIC_ADDR_R 0x79
...
#define OLED_CHARGEPUMP_0		0x10
#define OLED_CHARGEPUMP_1		0x14
